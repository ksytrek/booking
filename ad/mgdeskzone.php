                    ...
                    <div class="row">
                        <div class="col-md-8 text-center text-md-left">
                            <div class="call-to-action-text">
                                <h3 class="action-title">ตารางจัดการข้อมูลโต๊ะ-โซน</h3>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 ">
                        <div class="ts-service-box">
                            ...
                            <table id="mgdeskZone" class="table  table-borderless " style="width:100%">
                                <thead>
                                    <tr class="text-center">
                                        <th>ลำดับ</th>
                                        <th>โซน</th>
                                        <th>โต๊ะ</th>
                                        <th><a href="javascript:$('#addDesk_modal').modal('show');">เพิ่มโต๊ะ</a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="text-center">
                            ...
                            <script>
                                ...
                                function ad_mgdeskZone() {
                                    $('#mgdeskZone').DataTable({
                                        dom: 'lBfrtip',
                                        lengthMenu: [
                                            [10, 25, 50, 60, -1],
                                            [10, 25, 50, 60, "All"]
