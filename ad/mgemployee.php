                    ...
                    <div class="row">
                        <div class="col-md-8 text-center text-md-left">
                            <div class="call-to-action-text">
                                <h3 class="action-title">ตารางจัดการข้อมูลพนักงาน</h3>
                            </div>
                        </div>
                            ...
                            <table id="mgCustomer" class="table  table-borderless " style="width:100%">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th>ชื่อผู้ใช้</th>
                                        <th>รหัสผ่าน</th>
                                        <th><a href="javascript:$('#addCustomer_modal').modal('show');">เพิ่มพนักงานใหม่</a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr class="text-center">
  ...
  ================================================== -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">เพิ่มพนักงานใหม่</h5>
    ...
    <div class="modal fade" id="editCustomer_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">แก้ไขข้อมูลพนักงาน</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
