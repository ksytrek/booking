                ...
                <div class="container">
                    <div class="box-slider-content">
                        <div class="box-slider-text">
                            ...
                            <p>
                                <a href="javascript:$('#reserve_table').modal('show');" class="slider btn btn-primary">จอง</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 text-center text-md-left">
                            <div class="call-to-action-text">
                                <h3 class="action-title">ตารางการจอง <span style="color: red">คลิ๊กเลือกวันที่ปฏิทินเพื่อจอง</span></h3>
                            </div>
                        </div>
